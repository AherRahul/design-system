...
## Comments:
The URL provided to the component must contain the file extension at the end. Only files with extensions _png_, _jpg_, _jpeg_ and _webp_ will have the preview generated.
<br />
