...
### Componente auxiliar utilizado para adicionar paddings e margins seguindo o padrão de tokens do RDS.
---
<br />
...
utilize classes e nelas inclua paddings e margins com os tokens de espaçamento do RDS.

<br />

## Comments:
- ⚠️ Dê preferência sempre que possível à utilização dos tokens em detrimento ao Spacer.
- O valor mandado para as props do Spacer é sempre multiplicado por 4, assim como nos tokens scss do RDS.
