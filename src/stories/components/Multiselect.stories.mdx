...
## Observações:
- O Multiselect do RDS é um wrapper do <a href="https://vue-multiselect.js.org/">Vue Multiselect</a>
com a sua adequação aos nossos Principles e recomendações. Para informações detalhadas sobre o componente, recomendamos
