		...
		>
			...
			>
				...
				<div class="bottom-sheet__content">
					<!-- @slot Scoped slot used to insert customized content. -->
					<slot name="default" />
				</div>
			</div>
		</div>
...
export default {
	...
	props: {
		/**
		 *  Controls the display of the bottom sheet.
		 */
		modelValue: {
			type: Boolean,
			default: false,
		...
		/**
		 * Defines the title of the bottom sheet displayed in the header
		 */
		title: {
			type: String,
			default: 'Where to find my CNS',
		},
	},

	emits: [
		/**
		 * Event emitted when the visibility of the bottom sheet is changed.
